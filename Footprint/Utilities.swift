...
extension MKMapRect {
    ...
    */
    func getCenter() -> MKMapPoint {
        return MKMapPoint(x: self.midX, y: self.midY)
    }
    ...
    */
    func polygonFromMapRect() -> MKPolygon {
        var corners =  [MKMapPoint(x: self.maxX,  y: self.maxY),
                        MKMapPoint(x: self.minX,  y: self.maxY),
                        MKMapPoint(x: self.minX,  y: self.minY),
                        MKMapPoint(x: self.maxX,  y: self.minY)]
